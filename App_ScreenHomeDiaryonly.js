...
export default function ScreenHome({ navigation }) {
  ...
  return (
    ...
    <View style={{ height: wheight, marginTop: 1, }}>
      <ListSideMenu.Navigator initialRouteName="List" screenOptions={
        {
        ...
        <Stack.Screen name="Tags" component={ScreenHomeTags} options={{ drawerLabel: () => null }} />
